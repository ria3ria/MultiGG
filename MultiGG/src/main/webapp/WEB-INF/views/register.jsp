...
<form  method="post" onsubmit="return checkForm();" action="register.do">
 ...
 <div class="wrap">
        <div class="login">
            ...
            <div id="emailbox">
            <h4>ID(email)</h4>
            <button class="idCheck" type="button" id="idCheck" onclick="fn_IdCheck();" value="중복확인">중복확인</button>
            </div>
            ...
            <div class="loginform_input" id="loginnickname">
                <h4>Nickname</h4>
                <input type="text" name="membernickname" onclick="idChkConfirm();" id="" placeholder="닉네임" required="required">
            </div>
